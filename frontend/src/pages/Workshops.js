        ...
        <>
            <div id="whole" className="d-flex flex-column justify-content-start align-items-center mt-lg-5">
                <div className="container py-1 pb-5">
                    ...
                    <p><strong>Main Topics: </strong>We invite submissions on covering but not limited to the following topics:</p>
                    <p>
                    ...
                    <p><strong>Submission site: </strong><a target={"_blank"} href = "https://wi-lab.com/cyberchair/2025/icdm25/scripts/submit.php?subarea=S06&undisplay_detail=1&wh=/cyberchair/2025/icdm25/scripts/ws_submit.php">
                        https://wi-lab.com/cyberchair/2025/icdm25/scripts/submit.php?subarea=S06&undisplay_detail=1&wh=/cyberchair/2025/icdm25/scripts/ws_submit.php</a></p>
